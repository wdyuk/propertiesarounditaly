				    ...
				    <select class="custom-select mb-2" name="country">
				    	...
				    	<option value="Libyan Arab Jamahiri">Libyan Arab Jamahiri</option>
				    	...
				    	<option value="Unknown or unspecified">Unknown or unspecified</option>
