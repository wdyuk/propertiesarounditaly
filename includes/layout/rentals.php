<?php
    ...
    $total_rows = table_row_count('properties','type="Rental" AND status="1"');
    $total_pages = ceil($total_rows / $limit);
    
    $properties = table_fetch_rows('properties', 'type="Rental" and status="1"', 'price ASC', ($page-1) * $limit, $limit);
?>
